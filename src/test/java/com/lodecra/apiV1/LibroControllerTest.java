...
public class LibroControllerTest {
    ...
    public void cuandoLlamoAGetLibros_devuelveListaConUnSoloLibro()
        ...
        given(mapper.libroADto(libro)).willReturn(new LibroDto(libro.getId(), libro.getTitulo(),libro.getAutor(),libro.getPrecio(), libro.getEditorial(), libro.getContacto(), libro.getStock(), libro.getDescartado()));
    ...
    public void cuandoBuscoUnLibroGral_devuelveListaConDosLibros()
        ...
        given(mapper.libroADto(libro1)).willReturn(new LibroDto(libro1.getId(), libro1.getTitulo(),libro1.getAutor(),libro1.getPrecio(), libro1.getEditorial(), libro1.getContacto(), libro1.getStock(), libro1.getDescartado()));
        given(mapper.libroADto(libro2)).willReturn(new LibroDto(libro2.getId(), libro2.getTitulo(),libro2.getAutor(),libro2.getPrecio(), libro2.getEditorial(), libro2.getContacto(), libro2.getStock(), libro2.getDescartado()));
